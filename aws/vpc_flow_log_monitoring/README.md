...
1. Create and configure a lambda function
   ...
   - Create a lambda function: Skip the blueprint, name it `functionname`, set the Runtime to `Python 3.11`, the handle to `lambda_function.lambda_handler`, and the role to `lambda_execution`.
