...
1. Create and configure a lambda function
   ...
   - Create a lambda function: skip the blueprint, name it `datadog-vpc-flow-log-monitoring`, set the runtime to `Python 2.7`, the handle to `lambda_function.lambda_handler`, and the role to `lambda_execution`.
